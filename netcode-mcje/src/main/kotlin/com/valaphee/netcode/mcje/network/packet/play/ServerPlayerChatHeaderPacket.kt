 ...
 * @author Kevin Ludwig
 */
class ServerPlayerChatHeaderPacket(
    val previousSignature: ByteArray?,
    val userId: UUID,
    val headerSignature: ByteArray,
    val bodyDigest: ByteArray
    ...
    override fun write(buffer: PacketBuffer, version: Int) {
        ...
        buffer.writeByteArray(headerSignature)
        buffer.writeByteArray(bodyDigest)
    }

    override fun handle(handler: ServerPlayPacketHandler) = handler.playerChatHeader(this)
