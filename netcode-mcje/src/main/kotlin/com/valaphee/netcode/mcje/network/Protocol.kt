...
enum class Protocols(
    ...
    Play(
        Protocol.Builder()
            .register(ClientTeleportConfirmPacket::class           , ClientTeleportConfirmPacketReader           , 754 to 0x00, 758 to 0x00, 759 to 0x00, 760 to 0x00)
            .register(ClientBlockQueryPacket::class                , ClientBlockQueryPacketReader                , 754 to 0x01, 758 to 0x01, 759 to 0x01, 760 to 0x01)
            .register(ClientDifficultyPacket::class                , ClientDifficultyPacketReader                , 754 to 0x02, 758 to 0x02, 759 to 0x02, 760 to 0x02)
            //ChatConfirmPacket
            .register(ClientCommandPacket::class                   , ClientCommandPacketReader                   ,                           759 to 0x03, 760 to 0x04)
            .register(ClientPlayerChatPacket::class                , ClientPlayerChatPacketReader                , 754 to 0x03, 758 to 0x03, 759 to 0x04, 760 to 0x05)
            .register(ClientPlayerChatPreviewPacket::class         , ClientPlayerChatPreviewPacketReader         ,                           759 to 0x05, 760 to 0x06)
            .register(ClientStatusPacket::class                    , ClientStatusPacketReader                    , 754 to 0x04, 758 to 0x04, 759 to 0x06, 760 to 0x07)
            .register(ClientSettingsPacket::class                  , ClientSettingsPacketReader                  , 754 to 0x05, 758 to 0x05, 759 to 0x07, 760 to 0x08)
            .register(ClientCommandSuggestPacket::class            , ClientCommandSuggestPacketReader            , 754 to 0x06, 758 to 0x06, 759 to 0x08, 760 to 0x09)
            .register(ClientWindowConfirmPacket::class             , ClientWindowConfirmPacketReader             , 754 to 0x07                                       )
            .register(ClientWindowClickButtonPacket::class         , ClientWindowClickButtonPacketReader         , 754 to 0x08, 758 to 0x07, 759 to 0x09, 760 to 0x0A)
            .register(ClientWindowClickPacket::class               , ClientWindowClickPacketReader               , 754 to 0x09, 758 to 0x08, 759 to 0x0A, 760 to 0x0B)
            .register(ClientWindowClosePacket::class               , ClientWindowClosePacketReader               , 754 to 0x0A, 758 to 0x09, 759 to 0x0B, 760 to 0x0C)
            .register(ClientCustomPayloadPacket::class             , ClientCustomPayloadPacketReader             , 754 to 0x0B, 758 to 0x0A, 759 to 0x0C, 760 to 0x0D)
            .register(ClientBookEditPacket::class                  , ClientBookEditPacketReader                  , 754 to 0x0C, 758 to 0x0B, 759 to 0x0D, 760 to 0x0E)
            .register(ClientEntityQueryPacket::class               , ClientEntityQueryPacketReader               , 754 to 0x0D, 758 to 0x0C, 759 to 0x0E, 760 to 0x0F)
            .register(ClientItemUseOnEntityPacket::class           , ClientItemUseOnEntityPacketReader           , 754 to 0x0E, 758 to 0x0D, 759 to 0x0F, 760 to 0x10)
            .register(ClientJigsawGeneratePacket::class            , ClientJigsawGeneratePacketReader            , 754 to 0x0F, 758 to 0x0E, 759 to 0x10, 760 to 0x11)
            .register(ClientKeepAlivePacket::class                 , ClientKeepAlivePacketReader                 , 754 to 0x10, 758 to 0x0F, 759 to 0x11, 760 to 0x12)
            .register(ClientDifficultyLockPacket::class            , ClientDifficultyLockPacketReader            , 754 to 0x11, 758 to 0x10, 759 to 0x12, 760 to 0x13)
            .register(ClientLocationPacket::class                  , ClientPositionPacketReader                  , 754 to 0x12, 758 to 0x11, 759 to 0x13, 760 to 0x14)
            .register(null                                         , ClientPositionRotationPacketReader          , 754 to 0x13, 758 to 0x12, 759 to 0x14, 760 to 0x15)
            .register(null                                         , ClientRotationPacketReader                  , 754 to 0x14, 758 to 0x13, 759 to 0x15, 760 to 0x16)
            .register(null                                         , ClientLocationPacketReader                  , 754 to 0x15, 758 to 0x14, 759 to 0x16, 760 to 0x17)
            .register(ClientVehicleLocationPacket::class           , ClientVehicleLocationPacketReader           , 754 to 0x16, 758 to 0x15, 759 to 0x17, 760 to 0x18)
            .register(ClientSteerBoatPacket::class                 , ClientSteerBoatPacketReader                 , 754 to 0x17, 758 to 0x16, 759 to 0x18, 760 to 0x19)
            .register(ClientItemPickPacket::class                  , ClientItemPickPacketReader                  , 754 to 0x18, 758 to 0x17, 759 to 0x19, 760 to 0x1A)
            .register(ClientCraftPacket::class                     , ClientCraftPacketReader                     , 754 to 0x19, 758 to 0x18, 759 to 0x1A, 760 to 0x1B)
            .register(ClientAbilitiesPacket::class                 , ClientAbilitiesPacketReader                 , 754 to 0x1A, 758 to 0x19, 759 to 0x1B, 760 to 0x1C)
            .register(ClientActionPacket::class                    , ClientActionPacketReader                    , 754 to 0x1B, 758 to 0x1A, 759 to 0x1C, 760 to 0x1D)
            .register(ClientPlayerActionPacket::class              , ClientPlayerActionPacketReader              , 754 to 0x1C, 758 to 0x1B, 759 to 0x1D, 760 to 0x1E)
            .register(ClientSteerPacket::class                     , ClientSteerPacketReader                     , 754 to 0x1D, 758 to 0x1C, 759 to 0x1E, 760 to 0x1F)
            .register(ClientPongPacket::class                      , ClientPongPacketReader                      ,              758 to 0x1D, 759 to 0x1F, 760 to 0x20)
            .register(ClientRecipeBookStatePacket::class           , ClientRecipeBookStatePacketReader           , 754 to 0x1E, 758 to 0x1E, 759 to 0x20, 760 to 0x21)
            .register(ClientRecipeBookDisplayRecipePacket::class   , ClientRecipeBookDisplayRecipePacketReader   , 754 to 0x1F, 758 to 0x1F, 759 to 0x21, 760 to 0x22)
            .register(ClientItemNamePacket::class                  , ClientItemNamePacketReader                  , 754 to 0x20, 758 to 0x20, 759 to 0x22, 760 to 0x23)
            .register(ClientResourcePackStatusPacket::class        , ClientResourcePackStatusPacketReader        , 754 to 0x21, 758 to 0x21, 759 to 0x23, 760 to 0x24)
            .register(ClientAdvancementTabPacket::class            , ClientAdvancementTabPacketReader            , 754 to 0x22, 758 to 0x22, 759 to 0x24, 760 to 0x25)
            .register(ClientTradePacket::class                     , ClientTradePacketReader                     , 754 to 0x23, 758 to 0x23, 759 to 0x25, 760 to 0x26)
            .register(ClientBeaconUpdatePacket::class              , ClientBeaconUpdatePacketReader              , 754 to 0x24, 758 to 0x24, 759 to 0x26, 760 to 0x27)
            .register(ClientHotbarPacket::class                    , ClientHotbarPacketReader                    , 754 to 0x25, 758 to 0x25, 759 to 0x27, 760 to 0x28)
            .register(ClientCommandBlockUpdatePacket::class        , ClientCommandBlockUpdatePacketReader        , 754 to 0x26, 758 to 0x26, 759 to 0x28, 760 to 0x29)
            .register(ClientCommandBlockMinecartUpdatePacket::class, ClientCommandBlockMinecartUpdatePacketReader, 754 to 0x27, 758 to 0x27, 759 to 0x29, 760 to 0x2A)
            .register(ClientCreativeInventorySlotPacket::class     , ClientCreativeInventorySlotPacketReader     , 754 to 0x28, 758 to 0x28, 759 to 0x2A, 760 to 0x2B)
            .register(ClientJigsawBlockUpdatePacket::class         , ClientJigsawBlockUpdatePacketReader         , 754 to 0x29, 758 to 0x29, 759 to 0x2B, 760 to 0x2C)
            .register(ClientStructureBlockUpdatePacket::class      , ClientStructureBlockUpdatePacketReader      , 754 to 0x2A, 758 to 0x2A, 759 to 0x2C, 760 to 0x2D)
            .register(ClientSignUpdatePacket::class                , ClientSignUpdatePacketReader                , 754 to 0x2B, 758 to 0x2B, 759 to 0x2D, 760 to 0x2E)
            .register(ClientSwingArmPacket::class                  , ClientSwingArmPacketReader                  , 754 to 0x2C, 758 to 0x2C, 759 to 0x2E, 760 to 0x2F)
            .register(ClientSpectatePacket::class                  , ClientSpectatePacketReader                  , 754 to 0x2D, 758 to 0x2D, 759 to 0x2F, 760 to 0x30)
            .register(ClientBlockPlacePacket::class                , ClientBlockPlacePacketReader                , 754 to 0x2E, 758 to 0x2E, 759 to 0x30, 760 to 0x31)
            .register(ClientItemUsePacket::class                   , ClientItemUsePacketReader                   , 754 to 0x2F, 758 to 0x2F, 759 to 0x31, 760 to 0x32)
            .build(),
        Protocol.Builder()
            .register(ServerObjectAddPacket::class             , ServerObjectAddPacketReader               , 754 to 0x00, 758 to 0x00                          )
            .register(ServerExperienceOrbAddPacket::class      , ServerExperienceOrbAddPacketReader        , 754 to 0x01, 758 to 0x01, 759 to 0x01, 760 to 0x01)
            .register(ServerEntityAddPacket::class             , ServerEntityAddPacketReader               , 754 to 0x02, 758 to 0x02, 759 to 0x00, 760 to 0x00)
            .register(ServerPaintingAddPacket::class           , ServerPaintingAddPacketReader             , 754 to 0x03, 758 to 0x03                          )
            .register(ServerPlayerAddPacket::class             , ServerPlayerAddPacketReader               , 754 to 0x04, 758 to 0x04, 759 to 0x02, 760 to 0x02)
            .register(ServerEntityAnimationPacket::class       , ServerEntityAnimationPacketReader         , 754 to 0x05, 758 to 0x06, 759 to 0x03, 760 to 0x03)
            .register(ServerActionConfirmPacket::class         , ServerActionConfirmPacketReader           , 754 to 0x07, 758 to 0x08, 759 to 0x05, 760 to 0x05)
            .register(ServerBlockBreakAnimationPacket::class   , ServerBlockBreakAnimationPacketReader     , 754 to 0x08, 758 to 0x09, 759 to 0x06, 760 to 0x06)
            .register(ServerBlockEntityPacket::class           , ServerBlockEntityPacketReader             , 754 to 0x09, 758 to 0x0A, 759 to 0x07, 760 to 0x07)
            .register(ServerBlockEventPacket::class            , ServerBlockEventPacketReader              , 754 to 0x0A, 758 to 0x0B, 759 to 0x08, 760 to 0x08)
            .register(ServerBlockUpdatePacket::class           , ServerBlockUpdatePacketReader             , 754 to 0x0B, 758 to 0x0C, 759 to 0x09, 760 to 0x09)
            .register(ServerBossBarPacket::class               , ServerBossBarPacketReader                 , 754 to 0x0C, 758 to 0x0D, 759 to 0x0A, 760 to 0x0A)
            .register(ServerDifficultyPacket::class            , ServerDifficultyPacketReader              , 754 to 0x0D, 758 to 0x0E, 759 to 0x0B, 760 to 0x0B)
            .register(ServerPlayerChatPreviewPacket::class     , ServerPlayerChatPreviewPacketReader       ,                           759 to 0x0C, 760 to 0x0C)
            .register(null                                     , ServerTitleClearPacketReader              ,              758 to 0x10, 759 to 0x0D, 760 to 0x0D)
            .register(ServerCommandSuggestPacket::class        , ServerCommandSuggestPacketReader          , 754 to 0x0F, 758 to 0x11, 759 to 0x0E, 760 to 0x0E)
            .register(ServerWindowConfirmPacket::class         , ServerWindowConfirmPacketReader           , 754 to 0x11                                       )
            .register(ServerWindowClosePacket::class           , ServerWindowClosePacketReader             , 754 to 0x12, 758 to 0x13, 759 to 0x10, 760 to 0x10)
            .register(ServerInventoryContentPacket::class      , ServerInventoryContentPacketReader        , 754 to 0x13, 758 to 0x14, 759 to 0x11, 760 to 0x11)
            .register(ServerWindowPropertyPacket::class        , ServerWindowPropertyPacketReader          , 754 to 0x14, 758 to 0x15, 759 to 0x12, 760 to 0x12)
            .register(ServerInventorySlotPacket::class         , ServerInventorySlotPacketReader           , 754 to 0x15, 758 to 0x16, 759 to 0x13, 760 to 0x13)
            .register(ServerItemCooldownPacket::class          , ServerItemCooldownPacketReader            , 754 to 0x16, 758 to 0x17, 759 to 0x14, 760 to 0x14)

            .register(ServerCustomPayloadPacket::class         , ServerCustomPayloadPacketReader           , 754 to 0x17, 758 to 0x18, 759 to 0x15, 760 to 0x16)
            .register(ServerNamedSoundPacket::class            , ServerNamedSoundPacketReader              , 754 to 0x18, 758 to 0x19, 759 to 0x16, 760 to 0x17)
            //.register(ServerChatDeletePacket::class            , ServerChatDeletePacket                    ,                                      , 760 to 0x18)
            .register(ServerDisconnectPacket::class            , ServerDisconnectPacketReader              , 754 to 0x19, 758 to 0x1A, 759 to 0x17, 760 to 0x19)
            .register(ServerEntityEventPacket::class           , ServerEntityEventPacketReader             , 754 to 0x1A, 758 to 0x1B, 759 to 0x18, 760 to 0x1A)
            .register(ServerExplosionPacket::class             , ServerExplosionPacketReader               , 754 to 0x1B, 758 to 0x1C, 759 to 0x19, 760 to 0x1B)
            .register(ServerChunkUnloadPacket::class           , ServerChunkUnloadPacketReader             , 754 to 0x1C, 758 to 0x1D, 759 to 0x1A, 760 to 0x1C)
            .register(ServerGameStatePacket::class             , ServerGameStatePacketReader               , 754 to 0x1D, 758 to 0x1E, 759 to 0x1B, 760 to 0x1D)
            .register(ServerHorseWindowOpenPacket::class       , ServerHorseWindowOpenPacketReader         , 754 to 0x1E, 758 to 0x1F, 759 to 0x1C, 760 to 0x1E)
            .register(null                                     , ServerBorderInitializePacketReader        ,              758 to 0x20, 759 to 0x1D, 760 to 0x1F)
            .register(ServerKeepAlivePacket::class             , ServerKeepAlivePacketReader               , 754 to 0x1F, 758 to 0x21, 759 to 0x1E, 760 to 0x20)
            .register(ServerChunkPacket::class                 , ServerChunkPacketReader                   , 754 to 0x20, 758 to 0x22, 759 to 0x1F, 760 to 0x21)
            .register(ServerWorldEventPacket::class            , ServerWorldEventPacketReader              , 754 to 0x21, 758 to 0x23, 759 to 0x20, 760 to 0x22)
            .register(ServerParticlePacket::class              , ServerParticlePacketReader                , 754 to 0x22, 758 to 0x24, 759 to 0x21, 760 to 0x23)

            .register(ServerWorldPacket::class                 , ServerWorldPacketReader                   , 754 to 0x24, 758 to 0x26, 759 to 0x23, 760 to 0x25)
            .register(ServerMapPacket::class                   , ServerMapPacketReader                     , 754 to 0x25, 758 to 0x27, 759 to 0x24, 760 to 0x26)
            .register(ServerTradePacket::class                 , ServerTradePacketReader                   , 754 to 0x26, 758 to 0x28, 759 to 0x25, 760 to 0x27)
            .register(ServerEntityMoveRotatePacket::class      , ServerEntityMovePacketReader              , 754 to 0x27, 758 to 0x29, 759 to 0x26, 760 to 0x28)
            .register(null                                     , ServerEntityMoveRotatePacketReader        , 754 to 0x28, 758 to 0x2A, 759 to 0x27, 760 to 0x29)
            .register(null                                     , ServerEntityRotatePacketReader            , 754 to 0x29, 758 to 0x2B, 759 to 0x28, 760 to 0x2A)
            .register(null                                     , ServerEntityLocationPacketReader          , 754 to 0x2A                          )
            .register(ServerVehicleLocationPacket::class       , ServerVehicleLocationPacketReader         , 754 to 0x2B, 758 to 0x2C, 759 to 0x29, 760 to 0x2B)
            .register(ServerBookOpenPacket::class              , ServerBookOpenPacketReader                , 754 to 0x2C, 758 to 0x2D, 759 to 0x2A, 760 to 0x2C)
            .register(ServerWindowOpenPacket::class            , ServerWindowOpenPacketReader              , 754 to 0x2D, 758 to 0x2E, 759 to 0x2B, 760 to 0x2D)
            .register(ServerSignUpdatePacket::class            , ServerSignUpdatePacketReader              , 754 to 0x2E, 758 to 0x2F, 759 to 0x2C, 760 to 0x2E)
            .register(ServerPingPacket::class                  , ServerPingPacketReader                    ,              758 to 0x30, 759 to 0x2D, 760 to 0x2F)
            .register(ServerCraftPacket::class                 , ServerCraftPacketReader                   , 754 to 0x2F, 758 to 0x31, 759 to 0x2E, 760 to 0x30)
            .register(ServerAbilitiesPacket::class             , ServerAbilitiesPacketReader               , 754 to 0x30, 758 to 0x32, 759 to 0x2F, 760 to 0x31)
            //.register(ServerPlayerChatHeaderPacket::class      , ServerPlayerChatHeaderPacket              ,                                      , 760 to 0x32)
            .register(ServerPlayerChatPacket::class            , ServerPlayerChatPacketReader              ,                           759 to 0x30, 760 to 0x33)
            .register(ServerPlayerCombatEventPacket::class     , ServerPlayerCombatEventPacketReader       , 754 to 0x31, 758 to 0x33, 759 to 0x31, 760 to 0x34)
            .register(null                                     , ServerPlayerCombatEventEndPacketReader    ,              758 to 0x33, 759 to 0x31, 760 to 0x34)
            .register(null                                     , ServerPlayerCombatEventEnterPacketReader  ,              758 to 0x34, 759 to 0x32, 760 to 0x35)
            .register(null                                     , ServerPlayerCombatEventDeathPacketReader  ,              758 to 0x35, 759 to 0x33, 760 to 0x36)
            .register(ServerPlayerListPacket::class            , ServerPlayerListPacketReader              , 754 to 0x32, 758 to 0x36, 759 to 0x34, 760 to 0x37)
            .register(ServerLookAtPacket::class                , ServerLookAtPacketReader                  , 754 to 0x33, 758 to 0x37, 759 to 0x35, 760 to 0x38)
            .register(ServerLocationPacket::class              , ServerLocationPacketReader                , 754 to 0x34, 758 to 0x38, 759 to 0x36, 760 to 0x39)
            .register(ServerRecipeBookPacket::class            , ServerRecipeBookPacketReader              , 754 to 0x35, 758 to 0x39, 759 to 0x37, 760 to 0x3A)
            .register(ServerEntitiesRemovePacket::class        , ServerEntitiesRemovePacketReader          , 754 to 0x36, 758 to 0x3A, 759 to 0x38, 760 to 0x3B)
            .register(ServerEntityEffectRevokePacket::class    , ServerEntityEffectRevokePacketReader      , 754 to 0x37, 758 to 0x3B, 759 to 0x39, 760 to 0x3C)
            .register(ServerResourcePackPacket::class          , ServerResourcePackPacketReader            , 754 to 0x38, 758 to 0x3C, 759 to 0x3A, 760 to 0x3D)
            .register(ServerRespawnPacket::class               , ServerRespawnPacketReader                 , 754 to 0x39, 758 to 0x3D, 759 to 0x3B, 760 to 0x3E)
            .register(ServerEntityHeadRotationPacket::class    , ServerEntityHeadRotationPacketReader      , 754 to 0x3A, 758 to 0x3E, 759 to 0x3C, 760 to 0x3F)
            .register(ServerBlockUpdatesPacket::class          , ServerBlockUpdatesPacketReader            , 754 to 0x3B, 758 to 0x3F, 759 to 0x3D, 760 to 0x40)
            .register(null                                     , ServerTitleActionBarPacketReader          ,              758 to 0x41, 759 to 0x40, 760 to 0x43)
            .register(ServerBorderPacket::class                , ServerBorderPacketReader                  , 754 to 0x3D, 758 to 0x42, 759 to 0x41, 760 to 0x44)
            .register(null                                     , ServerBorderSetCenterPacketReader         ,              758 to 0x42, 759 to 0x41, 760 to 0x44)
            .register(null                                     , ServerBorderLerpSizePacketReader          ,              758 to 0x43, 759 to 0x42, 760 to 0x45)
            .register(null                                     , ServerBorderSetSizePacketReader           ,              758 to 0x44, 759 to 0x43, 760 to 0x46)
            .register(null                                     , ServerBorderSetWarningTimePacketReader    ,              758 to 0x45, 759 to 0x44, 760 to 0x47)
            .register(null                                     , ServerBorderSetWarningDistancePacketReader,              758 to 0x46, 759 to 0x45, 760 to 0x48)
            .register(ServerCameraPacket::class                , ServerCameraPacketReader                  , 754 to 0x3E, 758 to 0x47, 759 to 0x46, 760 to 0x49)
            .register(ServerHotbarPacket::class                , ServerHotbarPacketReader                  , 754 to 0x3F, 758 to 0x48, 759 to 0x47, 760 to 0x4A)
            .register(ServerChunkPublishPacket::class          , ServerChunkPublishPacketReader            , 754 to 0x40, 758 to 0x49, 759 to 0x48, 760 to 0x4B)
            .register(ServerViewDistancePacket::class          , ServerViewDistancePacketReader            , 754 to 0x41, 758 to 0x4A, 759 to 0x49, 760 to 0x4C)
            .register(ServerSpawnPositionPacket::class         , ServerSpawnPositionPacketReader           , 754 to 0x42, 758 to 0x4B, 759 to 0x4A, 760 to 0x4D)

            .register(ServerScoreboardDisplayPacket::class     , ServerScoreboardDisplayPacketReader       , 754 to 0x43, 758 to 0x4C, 759 to 0x4C, 760 to 0x4F)
            .register(ServerEntityMetadataPacket::class        , ServerEntityMetadataPacketReader          , 754 to 0x44, 758 to 0x4D, 759 to 0x4D, 760 to 0x50)
            .register(ServerEntityAttachPacket::class          , ServerEntityAttachPacketReader            , 754 to 0x45, 758 to 0x4E, 759 to 0x4E, 760 to 0x51)
            .register(ServerEntityVelocityPacket::class        , ServerEntityVelocityPacketReader          , 754 to 0x46, 758 to 0x4F, 759 to 0x4F, 760 to 0x52)
            .register(ServerEntityEquipmentPacket::class       , ServerEntityEquipmentPacketReader         , 754 to 0x47, 758 to 0x50, 759 to 0x50, 760 to 0x53)
            .register(ServerExperiencePacket::class            , ServerExperiencePacketReader              , 754 to 0x48, 758 to 0x51, 759 to 0x51, 760 to 0x54)
            .register(ServerHealthHungerSaturationPacket::class, ServerHealthHungerSaturationPacketReader  , 754 to 0x49, 758 to 0x52, 759 to 0x52, 760 to 0x55)
            .register(ServerObjectivePacket::class             , ServerObjectivePacketReader               , 754 to 0x4A, 758 to 0x53, 759 to 0x53, 760 to 0x56)
            .register(ServerEntityPassengersPacket::class      , ServerEntityPassengersPacketReader        , 754 to 0x4B, 758 to 0x54, 759 to 0x54, 760 to 0x57)
            .register(ServerTeamPacket::class                  , ServerTeamPacketReader                    , 754 to 0x4C, 758 to 0x55, 759 to 0x55, 760 to 0x58)
            .register(ServerScorePacket::class                 , ServerScorePacketReader                   , 754 to 0x4D, 758 to 0x56, 759 to 0x56, 760 to 0x59)
            .register(ServerSimulationDistancePacket::class    , ServerSimulationDistancePacketReader      ,              758 to 0x57, 759 to 0x57, 760 to 0x5A)
            .register(null                                     , ServerTitleSetSubTitlePacketReader        ,              758 to 0x58, 759 to 0x58, 760 to 0x5B)
            .register(ServerTimePacket::class                  , ServerTimePacketReader                    , 754 to 0x4E, 758 to 0x59, 759 to 0x59, 760 to 0x5C)
            .register(ServerTitlePacket::class                 , ServerTitlePacketReader                   , 754 to 0x4F                                       )
            .register(null                                     , ServerTitleSetTitlePacketReader           ,              758 to 0x5A, 759 to 0x5A, 760 to 0x5D)
            .register(null                                     , ServerTitleSetTimingsPacketReader         ,              758 to 0x5B, 759 to 0x5B, 760 to 0x5E)
            .register(ServerEntitySoundPacket::class           , ServerEntitySoundPacketReader             , 754 to 0x50, 758 to 0x5C, 759 to 0x5C, 760 to 0x5F)
            .register(ServerSoundPacket::class                 , ServerSoundPacketReader                   , 754 to 0x51, 758 to 0x5D, 759 to 0x5D, 760 to 0x60)
            .register(ServerSoundStopPacket::class             , ServerSoundStopPacketReader               , 754 to 0x52, 758 to 0x5E, 759 to 0x5E, 760 to 0x61)
            .register(ServerSystemChatPacket::class            , ServerSystemChatPacketReader              , 754 to 0x0E, 758 to 0x0F, 759 to 0x5F, 760 to 0x62)
            .register(ServerPlayerListHeaderFooterPacket::class, ServerPlayerListHeaderFooterPacketReader  , 754 to 0x53, 758 to 0x5F, 759 to 0x60, 760 to 0x63)
            .register(ServerQueryPacket::class                 , ServerQueryPacketReader                   , 754 to 0x54, 758 to 0x60, 759 to 0x61, 760 to 0x64)
            .register(ServerStackTakePacket::class             , ServerStackTakePacketReader               , 754 to 0x55, 758 to 0x61, 759 to 0x62, 760 to 0x65)
            .register(ServerEntityTeleportPacket::class        , ServerEntityTeleportPacketReader          , 754 to 0x56, 758 to 0x62, 759 to 0x63, 760 to 0x66)
            .register(ServerEntityAttributesPacket::class      , ServerEntityAttributesPacketReader        , 754 to 0x58, 758 to 0x64, 759 to 0x65, 760 to 0x68)
            .register(ServerEntityEffectApplyPacket::class     , ServerEntityEffectApplyPacketReader       , 754 to 0x59, 758 to 0x65, 759 to 0x66, 760 to 0x69)
            .register(ServerRecipesPacket::class               , ServerRecipesPacketReader                 , 754 to 0x5A, 758 to 0x66, 759 to 0x67, 760 to 0x6A)
            .build()
    )
}
