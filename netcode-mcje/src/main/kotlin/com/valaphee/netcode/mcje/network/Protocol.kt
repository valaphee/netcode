...
enum class Protocols(
    ...
    Play(
        Protocol.Builder()
            .register(ClientTeleportConfirmPacket::class           , ClientTeleportConfirmPacketReader           , 754 to 0x00, 758 to 0x00)
            .register(ClientBlockQueryPacket::class                , ClientBlockQueryPacketReader                , 754 to 0x01, 758 to 0x01)
            .register(ClientDifficultyPacket::class                , ClientDifficultyPacketReader                , 754 to 0x02, 758 to 0x02)
            .register(ClientTextPacket::class                      , ClientTextPacketReader                      , 754 to 0x03, 758 to 0x03)
            .register(ClientStatusPacket::class                    , ClientStatusPacketReader                    , 754 to 0x04, 758 to 0x04)
            .register(ClientSettingsPacket::class                  , ClientSettingsPacketReader                  , 754 to 0x05, 758 to 0x05)
            .register(ClientCommandSuggestPacket::class            , ClientCommandSuggestPacketReader            , 754 to 0x06, 758 to 0x06)
            .register(ClientWindowConfirmPacket::class             , ClientWindowConfirmPacketReader             , 754 to 0x07             )
            .register(ClientWindowClickButtonPacket::class         , ClientWindowClickButtonPacketReader         , 754 to 0x08, 758 to 0x07)
            .register(ClientWindowClickPacket::class               , ClientWindowClickPacketReader               , 754 to 0x09, 758 to 0x08)
            .register(ClientWindowClosePacket::class               , ClientWindowClosePacketReader               , 754 to 0x0A, 758 to 0x09)
            .register(ClientCustomPayloadPacket::class             , ClientCustomPayloadPacketReader             , 754 to 0x0B, 758 to 0x0A)
            .register(ClientBookEditPacket::class                  , ClientBookEditPacketReader                  , 754 to 0x0C, 758 to 0x0B)
            .register(ClientEntityQueryPacket::class               , ClientEntityQueryPacketReader               , 754 to 0x0D, 758 to 0x0C)
            .register(ClientItemUseOnEntityPacket::class           , ClientItemUseOnEntityPacketReader           , 754 to 0x0E, 758 to 0x0D)
            .register(ClientKeepAlivePacket::class                 , ClientKeepAlivePacketReader                 , 754 to 0x10, 758 to 0x0F)
            .register(ClientLocationPacket::class                  , ClientPositionPacketReader                  , 754 to 0x12, 758 to 0x11)
            .register(null                                         , ClientPositionRotationPacketReader          , 754 to 0x13, 758 to 0x12)
            .register(null                                         , ClientRotationPacketReader                  , 754 to 0x14, 758 to 0x13)
            .register(null                                         , ClientLocationPacketReader                  , 754 to 0x15, 758 to 0x14)
            .register(ClientVehicleLocationPacket::class           , ClientVehicleLocationPacketReader           , 754 to 0x16, 758 to 0x15)
            .register(ClientSteerBoatPacket::class                 , ClientSteerBoatPacketReader                 , 754 to 0x17, 758 to 0x16)
            .register(ClientItemPickPacket::class                  , ClientItemPickPacketReader                  , 754 to 0x18, 758 to 0x17)
            .register(ClientCraftPacket::class                     , ClientCraftPacketReader                     , 754 to 0x19, 758 to 0x18)
            .register(ClientAbilitiesPacket::class                 , ClientAbilitiesPacketReader                 , 754 to 0x1A, 758 to 0x19)
            .register(ClientActionPacket::class                    , ClientActionPacketReader                    , 754 to 0x1B, 758 to 0x1A)
            .register(ClientPlayerActionPacket::class              , ClientPlayerActionPacketReader              , 754 to 0x1C, 758 to 0x1B)
            .register(ClientSteerPacket::class                     , ClientSteerPacketReader                     , 754 to 0x1D, 758 to 0x1C)
            .register(ClientPongPacket::class                      , ClientPongPacketReader                      ,              758 to 0x1D)
            .register(ClientRecipeBookStatePacket::class           , ClientRecipeBookStatePacketReader           , 754 to 0x1E, 758 to 0x1E)
            .register(ClientRecipeBookDisplayRecipePacket::class   , ClientRecipeBookDisplayRecipePacketReader   , 754 to 0x1F, 758 to 0x1F)
            .register(ClientItemNamePacket::class                  , ClientItemNamePacketReader                  , 754 to 0x20, 758 to 0x20)
            .register(ClientResourcePackStatusPacket::class        , ClientResourcePackStatusPacketReader        , 754 to 0x21, 758 to 0x21)
            .register(ClientAdvancementTabPacket::class            , ClientAdvancementTabPacketReader            , 754 to 0x22, 758 to 0x22)
            .register(ClientTradePacket::class                     , ClientTradePacketReader                     , 754 to 0x23, 758 to 0x23)
            .register(ClientBeaconUpdatePacket::class              , ClientBeaconUpdatePacketReader              , 754 to 0x24, 758 to 0x24)
            .register(ClientHotbarPacket::class                    , ClientHotbarPacketReader                    , 754 to 0x25, 758 to 0x25)
            .register(ClientCommandBlockUpdatePacket::class        , ClientCommandBlockUpdatePacketReader        , 754 to 0x26, 758 to 0x26)
            .register(ClientCommandBlockMinecartUpdatePacket::class, ClientCommandBlockMinecartUpdatePacketReader, 754 to 0x27, 758 to 0x27)
            .register(ClientCreativeInventorySlotPacket::class     , ClientCreativeInventorySlotPacketReader     , 754 to 0x28, 758 to 0x28)
            .register(ClientJigsawBlockUpdatePacket::class         , ClientJigsawBlockUpdatePacketReader         , 754 to 0x29, 758 to 0x29)
            .register(ClientStructureBlockUpdatePacket::class      , ClientStructureBlockUpdatePacketReader      , 754 to 0x2A, 758 to 0x2A)
            .register(ClientSignUpdatePacket::class                , ClientSignUpdatePacketReader                , 754 to 0x2B, 758 to 0x2B)
            .register(ClientSwingArmPacket::class                  , ClientSwingArmPacketReader                  , 754 to 0x2C, 758 to 0x2C)
            .register(ClientSpectatePacket::class                  , ClientSpectatePacketReader                  , 754 to 0x2D, 758 to 0x2D)
            .register(ClientBlockPlacePacket::class                , ClientBlockPlacePacketReader                , 754 to 0x2E, 758 to 0x2E)
            .register(ClientItemUsePacket::class                   , ClientItemUsePacketReader                   , 754 to 0x2F, 758 to 0x2F)
            .build(),
        Protocol.Builder()
            .register(ServerObjectAddPacket::class             , ServerObjectAddPacketReader               , 754 to 0x00, 758 to 0x00)
            .register(ServerExperienceOrbAddPacket::class      , ServerExperienceOrbAddPacketReader        , 754 to 0x01, 758 to 0x01)
            .register(ServerEntityAddPacket::class             , ServerEntityAddPacketReader               , 754 to 0x02, 758 to 0x02)
            .register(ServerPaintingAddPacket::class           , ServerPaintingAddPacketReader             , 754 to 0x03, 758 to 0x03)
            .register(ServerPlayerAddPacket::class             , ServerPlayerAddPacketReader               , 754 to 0x04, 758 to 0x04)
            .register(ServerEntityAnimationPacket::class       , ServerEntityAnimationPacketReader         , 754 to 0x05, 758 to 0x06)
            .register(ServerActionResponsePacket::class        , ServerActionResponsePacketReader          , 754 to 0x07, 758 to 0x08)
            .register(ServerBlockBreakAnimationPacket::class   , ServerBlockBreakAnimationPacketReader     , 754 to 0x08, 758 to 0x09)
            .register(ServerBlockEntityPacket::class           , ServerBlockEntityPacketReader             , 754 to 0x09, 758 to 0x0A)
            .register(ServerBlockEventPacket::class            , ServerBlockEventPacketReader              , 754 to 0x0A, 758 to 0x0B)
            .register(ServerBlockUpdatePacket::class           , ServerBlockUpdatePacketReader             , 754 to 0x0B, 758 to 0x0C)
            .register(ServerBossBarPacket::class               , ServerBossBarPacketReader                 , 754 to 0x0C, 758 to 0x0D)
            .register(ServerDifficultyPacket::class            , ServerDifficultyPacketReader              , 754 to 0x0D, 758 to 0x0E)
            .register(ServerTextPacket::class                  , ServerTextPacketReader                    , 754 to 0x0E, 758 to 0x0F)
            .register(null                                     , ServerTitleClearPacketReader              ,              758 to 0x10)
            .register(ServerCommandSuggestPacket::class        , ServerCommandSuggestPacketReader          , 754 to 0x0F, 758 to 0x11)
            .register(ServerWindowConfirmPacket::class         , ServerWindowConfirmPacketReader           , 754 to 0x11             )
            .register(ServerWindowClosePacket::class           , ServerWindowClosePacketReader             , 754 to 0x12, 758 to 0x13)
            .register(ServerInventoryContentPacket::class      , ServerInventoryContentPacketReader        , 754 to 0x13, 758 to 0x14)
            .register(ServerWindowPropertyPacket::class        , ServerWindowPropertyPacketReader          , 754 to 0x14, 758 to 0x15)
            .register(ServerInventorySlotPacket::class         , ServerInventorySlotPacketReader           , 754 to 0x15, 758 to 0x16)
            .register(ServerItemCooldownPacket::class          , ServerItemCooldownPacketReader            , 754 to 0x16, 758 to 0x17)
            .register(ServerCustomPayloadPacket::class         , ServerCustomPayloadPacketReader           , 754 to 0x17, 758 to 0x18)
            .register(ServerNamedSoundPacket::class            , ServerNamedSoundPacketReader              , 754 to 0x18, 758 to 0x19)
            .register(ServerDisconnectPacket::class            , ServerDisconnectPacketReader              , 754 to 0x19, 758 to 0x1A)
            .register(ServerEntityEventPacket::class           , ServerEntityEventPacketReader             , 754 to 0x1A, 758 to 0x1B)
            .register(ServerExplosionPacket::class             , ServerExplosionPacketReader               , 754 to 0x1B, 758 to 0x1C)
            .register(ServerChunkUnloadPacket::class           , ServerChunkUnloadPacketReader             , 754 to 0x1C, 758 to 0x1D)
            .register(ServerGameStatePacket::class             , ServerGameStatePacketReader               , 754 to 0x1D, 758 to 0x1E)
            .register(ServerHorseWindowOpenPacket::class       , ServerHorseWindowOpenPacketReader         , 754 to 0x1E, 758 to 0x1F)
            .register(null                                     , ServerBorderInitializePacketReader        ,              758 to 0x20)
            .register(ServerKeepAlivePacket::class             , ServerKeepAlivePacketReader               , 754 to 0x1F, 758 to 0x21)
            .register(ServerChunkPacket::class                 , ServerChunkPacketReader                   , 754 to 0x20, 758 to 0x22)
            .register(ServerWorldEventPacket::class            , ServerWorldEventPacketReader              , 754 to 0x21, 758 to 0x23)
            .register(ServerParticlePacket::class              , ServerParticlePacketReader                , 754 to 0x22, 758 to 0x24)
            .register(ServerWorldPacket::class                 , ServerWorldPacketReader                   , 754 to 0x24, 758 to 0x26)
            .register(ServerMapPacket::class                   , ServerMapPacketReader                     , 754 to 0x25, 758 to 0x27)
            .register(ServerTradePacket::class                 , ServerTradePacketReader                   , 754 to 0x26, 758 to 0x28)
            .register(ServerEntityMoveRotatePacket::class      , ServerEntityMovePacketReader              , 754 to 0x27, 758 to 0x29)
            .register(null                                     , ServerEntityMoveRotatePacketReader        , 754 to 0x28, 758 to 0x2A)
            .register(null                                     , ServerEntityRotatePacketReader            , 754 to 0x29, 758 to 0x2B)
            .register(null                                     , ServerEntityLocationPacketReader          , 754 to 0x2A             )
            .register(ServerVehicleLocationPacket::class       , ServerVehicleLocationPacketReader         , 754 to 0x2B, 758 to 0x2C)
            .register(ServerBookOpenPacket::class              , ServerBookOpenPacketReader                , 754 to 0x2C, 758 to 0x2D)
            .register(ServerWindowOpenPacket::class            , ServerWindowOpenPacketReader              , 754 to 0x2D, 758 to 0x2E)
            .register(ServerSignUpdatePacket::class            , ServerSignUpdatePacketReader              , 754 to 0x2E, 758 to 0x2F)
            .register(ServerSignUpdatePacket::class            , ServerSignUpdatePacketReader              ,              758 to 0x30)
            .register(ServerCraftPacket::class                 , ServerCraftPacketReader                   , 754 to 0x2F, 758 to 0x31)
            .register(ServerAbilitiesPacket::class             , ServerAbilitiesPacketReader               , 754 to 0x30, 758 to 0x32)
            .register(ServerPlayerCombatEventPacket::class     , ServerPlayerCombatEventPacketReader       , 754 to 0x31             )
            .register(null                                     , ServerPlayerCombatEventEndPacketReader    ,              758 to 0x33)
            .register(null                                     , ServerPlayerCombatEventEnterPacketReader  ,              758 to 0x34)
            .register(null                                     , ServerPlayerCombatEventDeathPacketReader  ,              758 to 0x35)
            .register(ServerPlayerListPacket::class            , ServerPlayerListPacketReader              , 754 to 0x32, 758 to 0x36)
            .register(ServerLookAtPacket::class                , ServerLookAtPacketReader                  , 754 to 0x33, 758 to 0x37)
            .register(ServerLocationPacket::class              , ServerLocationPacketReader                , 754 to 0x34, 758 to 0x38)
            .register(ServerRecipeBookPacket::class            , ServerRecipeBookPacketReader              , 754 to 0x35, 758 to 0x39)
            .register(ServerEntitiesRemovePacket::class        , ServerEntitiesRemovePacketReader          , 754 to 0x36, 758 to 0x3A)
            .register(ServerEntityEffectRevokePacket::class    , ServerEntityEffectRevokePacketReader      , 754 to 0x37, 758 to 0x3B)
            .register(ServerResourcePackPacket::class          , ServerResourcePackPacketReader            , 754 to 0x38, 758 to 0x3C)
            .register(ServerRespawnPacket::class               , ServerRespawnPacketReader                 , 754 to 0x39, 758 to 0x3D)
            .register(ServerEntityHeadRotationPacket::class    , ServerEntityHeadRotationPacketReader      , 754 to 0x3A, 758 to 0x3E)
            .register(ServerBlockUpdatesPacket::class          , ServerBlockUpdatesPacketReader            , 754 to 0x3B, 758 to 0x3F)
            .register(ServerBorderPacket::class                , ServerBorderPacketReader                  , 754 to 0x3D             )
            .register(null                                     , ServerTitleActionBarPacketReader          ,              758 to 0x41)
            .register(null                                     , ServerBorderSetCenterPacketReader         ,              758 to 0x42)
            .register(null                                     , ServerBorderLerpSizePacketReader          ,              758 to 0x43)
            .register(null                                     , ServerBorderSetSizePacketReader           ,              758 to 0x44)
            .register(null                                     , ServerBorderSetWarningTimePacketReader    ,              758 to 0x45)
            .register(null                                     , ServerBorderSetWarningDistancePacketReader,              758 to 0x46)
            .register(ServerCameraPacket::class                , ServerCameraPacketReader                  , 754 to 0x3E, 758 to 0x47)
            .register(ServerHotbarPacket::class                , ServerHotbarPacketReader                  , 754 to 0x3F, 758 to 0x48)
            .register(ServerChunkPublishPacket::class          , ServerChunkPublishPacketReader            , 754 to 0x40, 758 to 0x49)
            .register(ServerViewDistancePacket::class          , ServerViewDistancePacketReader            , 754 to 0x41, 758 to 0x4A)
            .register(ServerSpawnPositionPacket::class         , ServerSpawnPositionPacketReader           , 754 to 0x42, 758 to 0x4B)
            .register(ServerScoreboardDisplayPacket::class     , ServerScoreboardDisplayPacketReader       , 754 to 0x43, 758 to 0x4C)
            .register(ServerEntityMetadataPacket::class        , ServerEntityMetadataPacketReader          , 754 to 0x44, 758 to 0x4D)
            .register(ServerEntityAttachPacket::class          , ServerEntityAttachPacketReader            , 754 to 0x45, 758 to 0x4E)
            .register(ServerEntityVelocityPacket::class        , ServerEntityVelocityPacketReader          , 754 to 0x46, 758 to 0x4F)
            .register(ServerEntityEquipmentPacket::class       , ServerEntityEquipmentPacketReader         , 754 to 0x47, 758 to 0x50)
            .register(ServerExperiencePacket::class            , ServerExperiencePacketReader              , 754 to 0x48, 758 to 0x51)
            .register(ServerHealthHungerSaturationPacket::class, ServerHealthHungerSaturationPacketReader  , 754 to 0x49, 758 to 0x52)
            .register(ServerObjectivePacket::class             , ServerObjectivePacketReader               , 754 to 0x4A, 758 to 0x53)
            .register(ServerEntityPassengersPacket::class      , ServerEntityPassengersPacketReader        , 754 to 0x4B, 758 to 0x54)
            .register(ServerTeamPacket::class                  , ServerTeamPacketReader                    , 754 to 0x4C, 758 to 0x55)
            .register(ServerScorePacket::class                 , ServerScorePacketReader                   , 754 to 0x4D, 758 to 0x56)
            .register(ServerSimulationDistancePacket::class    , ServerSimulationDistancePacketReader      ,              758 to 0x57)
            .register(null                                     , ServerTitleSetSubTitlePacketReader        ,              758 to 0x58)
            .register(ServerTimePacket::class                  , ServerTimePacketReader                    , 754 to 0x4E, 758 to 0x59)
            .register(ServerTitlePacket::class                 , ServerTitlePacketReader                   , 754 to 0x4F             )
            .register(null                                     , ServerTitleSetTitlePacketReader           ,              758 to 0x5A)
            .register(null                                     , ServerTitleSetTimingsPacketReader         ,              758 to 0x5B)
            .register(ServerEntitySoundPacket::class           , ServerEntitySoundPacketReader             , 754 to 0x50, 758 to 0x5C)
            .register(ServerSoundPacket::class                 , ServerSoundPacketReader                   , 754 to 0x51, 758 to 0x5D)
            .register(ServerSoundStopPacket::class             , ServerSoundStopPacketReader               , 754 to 0x52, 758 to 0x5E)
            .register(ServerPlayerListHeaderFooterPacket::class, ServerPlayerListHeaderFooterPacketReader  , 754 to 0x53, 758 to 0x5F)
            .register(ServerQueryPacket::class                 , ServerQueryPacketReader                   , 754 to 0x54, 758 to 0x60)
            .register(ServerStackTakePacket::class             , ServerStackTakePacketReader               , 754 to 0x55, 758 to 0x61)
