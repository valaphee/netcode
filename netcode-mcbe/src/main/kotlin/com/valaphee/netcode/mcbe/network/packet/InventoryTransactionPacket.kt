...
import com.valaphee.netcode.mcbe.block.BlockState
    ...
    override fun write(buffer: PacketBuffer, version: Int) {
        ...
        when (type) {
            Type.ItemUse -> {
                ...
                buffer.writeVarUInt(buffer.registrySet.blockStates.getId(blockState!!))
            }
    ...
    override fun read(buffer: PacketBuffer, version: Int): InventoryTransactionPacket {
        ...
        when (type) {
            InventoryTransactionPacket.Type.ItemUse -> {
                ...
                headPosition = null
                blockState = checkNotNull(buffer.registrySet.blockStates[buffer.readVarUInt()])
            }
        ...
        return InventoryTransactionPacket(legacyRequestId, legacySlots, type, usingNetIds, actions, actionId, runtimeEntityId, position, blockFace, hotbarSlot, stackInHand, fromPosition, clickPosition, headPosition, blockState)
    }
}
