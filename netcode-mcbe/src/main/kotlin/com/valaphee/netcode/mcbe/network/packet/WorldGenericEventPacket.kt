...
class WorldGenericEventPacket(
    ...
    override fun toString() = "WorldGenericEventPacket(eventId=$eventId)"
}
...
object WorldGenericEventPacketReader : PacketReader {
    override fun read(buffer: PacketBuffer, version: Int) = WorldGenericEventPacket(buffer.readVarInt())
}
