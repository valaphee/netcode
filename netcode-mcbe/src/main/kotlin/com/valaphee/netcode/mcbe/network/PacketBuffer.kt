...
import com.valaphee.netcode.mcbe.util.ByteBufWrapper
...
class PacketBuffer(
    ...
    val jsonObjectMapper: ObjectMapper? = null,
    val nbtObjectMapper: ObjectMapper? = null,
    val registrySet: RegistrySet? = null
